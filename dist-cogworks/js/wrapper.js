...
if((window.location.href).search('/pages') < 0) {
    ...
    var prevBtn = document.getElementById('header-footer-pre');
    var nextBtn = document.getElementById('header-footer-next');
    var courseGated;
    var lastUpdated;
    var videoObj;
    let company;
    ...
    var setPage = () => {
        ...
        const setVideoOverlayWrapTop = () => {
            ...
            const rectWidth = iframeObj.document.getElementById('my-video').getClientRects()[0] !== undefined ? iframeObj.document.getElementById('my-video').getClientRects()[0].width : 0;
    ...
    var GetPlayer = () => {
        ...
        return {
            ...
            GetVar: (property) => {
                if (playerObj && playerObj.hasOwnProperty(property)) {
